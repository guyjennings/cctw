...
CctwTransformTest::CctwTransformTest(CctwqtApplication *app, QObject *parent) :
  ...
  m_GridBasis(m_Application->saver(), this, "gridBasis", QMatrix3x3(), "Grid Basis (recip latt units)"),
  m_GridBasisInv(m_Application->saver(), this, "gridBasisInv", QMatrix3x3(), "Grid Basis Inverse")
{
}
