...
CctwqtTransformTester::CctwqtTransformTester(CctwqtMainWindow *w, CctwCrystalCoordinateParameters *p, QcepObjectWPtr parent) :
...
void CctwqtTransformTester::testGetDetPos()
{
  ...
  CctwCrystalCoordinateTransform t(m_Parameters, "test", NULL, sharedFromThis());
