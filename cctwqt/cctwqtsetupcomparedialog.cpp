...
CctwqtSetupCompareDialog::CctwqtSetupCompareDialog(CctwqtMainWindow *parent, CctwComparerPtr data) :
  QDialog(parent),
...
void CctwqtSetupCompareDialog::accept()
{
  ...
  QtConcurrent::run(m_Data.data(), &CctwComparer::compareDatasets);
