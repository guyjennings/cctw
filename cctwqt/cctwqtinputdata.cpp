...
CctwqtInputData::CctwqtInputData(CctwIntVector3D dim, CctwIntVector3D chunkSize, /*CctwDoubleVector3D origin, CctwDoubleVector3D scale,*/ CctwInputDataFrameManager *manager, QObject *parent) :
